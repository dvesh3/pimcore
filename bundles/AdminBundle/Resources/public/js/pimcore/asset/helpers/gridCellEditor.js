...
Ext.define('pimcore.asset.helpers.gridCellEditor', {
    ...
    startEdit: function(el, value, /* private: false means don't focus*/
        ...
        if (tagType == "document" || tagType == "asset" || tagType == "object") {
            fieldInfo.layout.subType = tagType;
            tagType = "manyToOneRelation";
        }
        ...
        var tag = new pimcore.asset.tags[tagType](value, fieldInfo.layout);
        //var asset = Ext.clone(this.context.record);
