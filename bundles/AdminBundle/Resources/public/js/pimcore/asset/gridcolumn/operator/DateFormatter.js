...
pimcore.registerNS("pimcore.asset.gridcolumn.operator.dateformatter");

pimcore.asset.gridcolumn.operator.dateformatter = Class.create(pimcore.asset.gridcolumn.Abstract, {
